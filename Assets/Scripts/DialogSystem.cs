...
public class DialogSystem : MonoBehaviour
{
    ...
    private string[] voiceLines = {"Not many make it through the mirror maze. Still, I do not know your intentions. Many have tried hunting me to gain the power of wishing. None have succeeded. I am warning you: those with damaging dreams may not proceed further.",
    ...
    void Update()
    {
        voiceLineText.text = voiceLines[0];
    }
}
